...
public class PopularLectureAdapter extends RecyclerView.Adapter<PopularLectureAdapter.ViewHolder> {

    private static final String TAG = "LectureAdapter";
    private final OnListItemInteractionListener mOverflowMenuListener;
    private List<Lecture> mLectures;
    private final SimpleDateFormat mDateFormat;
    private Lecture selectedLecture;
    private Context mContext;

    public PopularLectureAdapter(Context context,@NonNull OnListItemInteractionListener overflowListener, @NonNull List<Lecture> lectureList) {
        mContext=context;
