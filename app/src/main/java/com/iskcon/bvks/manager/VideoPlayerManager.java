...
import com.iskcon.bvks.listeners.VideoPlayerCallBacks;
...
@Deprecated//Safe side class save(Original class)
public class VideoPlayerManager {
    ...
    VideoPlayerCallBacks.playerCallBack listner;
    ...
    public void setPlayerListener(VideoPlayerCallBacks.playerCallBack mPlayerCallBack) {
...
//            videoSource = new HlsMediaSource(mp4VideoUri, dataSourceFactory, null, null);
    ...
    public void setPlaylist(ArrayList<String> uriArrayList, Integer index, VideoPlayerCallBacks.playerCallBack callBack) {
